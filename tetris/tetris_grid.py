...
class TetrisGrid(Grid):
    ...
    def display_borders(self, screen: pygame.Surface):
        ...
        for row in self.blocks:
            for block in row:
                pygame.draw.line(
                    screen, Colors.GREY, (block.x, block.y), (block.x + 10, block.y)
                )
                pygame.draw.line(
                    screen,
                    Colors.DARK_GREY,
                ...
                pygame.draw.line(
                    screen, Colors.GREY, (block.x, block.y), (block.x, block.y + 10)
                )
                pygame.draw.line(
                    screen,
                    Colors.DARK_GREY,
                ...
                pygame.draw.line(
                    ...
                    (block.x + block_size - 10, block.y + block_size),
                )
                pygame.draw.line(
                    screen,
                    Colors.GREY,
                    (block.x + block_size, block.y + block_size),
                    (block.x + block_size, block.y + block_size - 10),
                )
                pygame.draw.line(
                    screen,
                    Colors.GREY,
